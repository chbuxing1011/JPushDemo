...
/**
 *  The configure cell callback called on `cellForRowAtIndexPath` to configure
 * the
 ...
 *
 */
typedef void (^AEFTableViewCellConfigureBlock)(id cell, id item,
...
AEFTableViewCellConfigureBlock configureCellBlock;

/**
 *  Return a new data source instance with a collection and configure block
 *
 *  @param collection         A collection of objects for the datasource to
 * manage
 *  @param configureCellBlock A block called when a cell requires configuration
 * inside `cellForRowAtIndexPath:`
 *
 *  @return A new table view data source instance with a collection and
 * configure block
 */
